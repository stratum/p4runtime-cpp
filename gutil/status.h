...
#ifndef GUTIL_STATUS_H_
#define GUTIL_STATUS_H_
...
class StatusBuilderHolder {
 public:
  explicit StatusBuilderHolder(const absl::Status& status) : builder_(status) {}
  explicit StatusBuilderHolder(absl::Status&& status)
